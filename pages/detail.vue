  ...
  <div class="detail-inner-wrap">
    <div class="article-wrap">
      ...
      <div class="content-wrap">
         <div class="content ql-editor" v-html="renderData.detail.ha_content"></div>
      </div>
    ...
    <div class="recom-more">
      ...
      <ul class="article-list-wrap">
        <li class="article-list-item" v-for="(item,index) in renderData.recommendList" :key="index" @click="handleJump(item)">
        <div class="cont">
          <p>{{item.ha_title}}</p>
          <ul class="tag-btm">
...
.detail-com-title em {
    ...
    color: #333;
    padding: 0 2px;
    background: -webkit-linear-gradient(top,hsla(0,0%,100%,.1) 50%,rgba(163,201,255,.35) 0);
    background: -webkit-gradient(linear,left top,left bottom,color-stop(50%,hsla(0,0%,100%,.1)),color-stop(50%,rgba(163,201,255,.35)));
    background: linear-gradient(180deg,hsla(0,0%,100%,.1) 50%,rgba(163,201,255,.35) 0)
}
