...
<div class="column-wrap">
  <div class="head">
    <div class="head-bg"><img alt="pic" :src="renderData.patentinfo.hp_bgurl" class="column-bg">
    </div>
    <section class="content-wrap">
      <div class="inner-wrap">
        <div class="avatar"><img alt="pic" :src="renderData.patentinfo.hp_headurl"></div>
        <div class="content">
...
export default {
  ...
  asyncData (params) {//请求
	return Vue.http.get(`/api/head/head/patentDetail?hp_id=${params.query.id || 2}`)
...
.column-wrap .avatar,.column-wrap .avatar img {
    height: 50px;
    width: 50px
}
